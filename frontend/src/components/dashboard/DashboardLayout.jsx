...
export default function DashboardLayout() {
  ...
  return (
    <div className="h-screen bg-dark-950 flex overflow-hidden">
      ...
      >
        {/* Logo */}
        <Link to="/" className="flex items-center gap-3 p-5 border-b border-white/5 hover:opacity-80 transition-opacity">
          ...
          >
            ...
            {!collapsed && (
              <div className="flex-1 flex items-center justify-between">
                ...
                <div className={`w-8 h-4 rounded-full relative transition-colors ${isDarkMode ? 'bg-primary-500' : 'bg-gray-400'}`}>
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        {/* Top Bar */}
        <header className="h-16 flex-shrink-0 bg-dark-900/50 backdrop-blur-xl border-b border-white/5 flex items-center px-6 gap-4 z-10">
          <button
          ...
          <div className="flex-1 flex justify-center items-center">
            <span 
              className="text-2xl font-black uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-accent-400 hidden md:block drop-shadow-md" 
